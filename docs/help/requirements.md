...
**REVO DNA 1.0.0 supports Blender 4.2–5.2 on Windows x64.** An AVX-capable processor is required.
...
The DNA runtime and NumPy are included. Character DNA, Epic's Faceboard layout and ROM FBX files are not.
